...
# # ==== COBOT ====
# # 🔌 Conexión con el Cobot Xarm.
# arm = XArmAPI('192.168.1.221') # direccion ip del Cobot
# time.sleep(1)
...
# arm.set_state(0)
# time.sleep(0.2)
# arm.ft_sensor_enable(1)  # Habilitar el sensor de fuerza
# arm.ft_sensor_set_zero() # Puede omitirse si ya se ha compensado el desplazamiento cero y la carga útil
# time.sleep(0.1)          # Esperar a que la operación de escritura cero surta efecto
...
REF1_INICIAL = 0.2404
REF2_INICIAL = 0.1161
REF1_FINAL = 0.0084709868903652
REF2_FINAL = 0.357199964428079
...
for i in range(MUESTRAS):
    ...
    # Cambio en la mitad de la trayectoria
    if i == MUESTRAS // 2:
        with ref_lock:
...
# Crear vector de evento (0 antes del cambio, 1 después)
